...
const GameBoard: React.FC<GameBoardProps> = ({ board, onCellClick, interactive = false }) => {
  return (
        ...
        {board.map((cell, index) => (
          <div 
            ...
            className={`
              ...
              ${interactive ? 'cursor-pointer hover:bg-white/5 rounded-xl transition-colors' : ''}
            `}
          ...
          >
            <AnimatePresence mode="wait">
              {cell === 'X' && (
                ...
                >
                  <svg width="60" height="60" viewBox="0 0 100 100" className="drop-shadow-[0_0_15px_rgba(0,212,255,0.8)]">
                    <line x1="20" y1="20" x2="80" y2="80" stroke="#00D4FF" strokeWidth="8" strokeLinecap="round" />
                    <line x1="80" y1="20" x2="20" y2="80" stroke="#00D4FF" strokeWidth="8" strokeLinecap="round" />
                  </svg>
                </motion.div>
              )}
              {cell === 'O' && (
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                >
                  <svg width="60" height="60" viewBox="0 0 100 100" className="drop-shadow-[0_0_15px_rgba(107,70,255,0.8)]">
                    <circle cx="50" cy="50" r="35" stroke="#6B46FF" strokeWidth="8" fill="none" strokeLinecap="round" />
                  </svg>
                </motion.div>
              )}
            </AnimatePresence>
