...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "relative inline-flex items-center justify-center font-semibold rounded-2xl transition-all duration-300 focus:outline-none overflow-hidden group";

  const variants = {
    primary:
      "bg-gradient-to-r from-primary to-secondary text-white shadow-[0_0_20px_rgba(107,70,255,0.3)] hover:shadow-[0_0_30px_rgba(0,212,255,0.5)] border border-transparent",
