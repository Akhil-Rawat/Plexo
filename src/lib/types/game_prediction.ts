  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "playerPrizeVault"; isMut: true; isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "bettorAta"; isMut: true; isSigner: false },
        { name: "bet"; isMut: true; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "side"; type: "u8" }, { name: "amount"; type: "u64" }];
    },
    {
      name: "closePool";
      accounts: [
    ...
    },
    {
      ...
      args: [
        ...
        { name: "playerShareBps"; type: "u16" }
      ];
    },
    {
      name: "claimSpectatorWinnings";
      accounts: [
  ...
  accounts: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "playerPrizeVault"; type: "publicKey" },
          { name: "bump"; type: "u8" },
          { name: "vaultBump"; type: "u8" },
          { name: "playerPrizeVaultBump"; type: "u8" },
          { name: "totalForA"; type: "u64" },
          { name: "totalForB"; type: "u64" },
          { name: "isOpen"; type: "bool" },
          { name: "isSettled"; type: "bool" },
          { name: "result"; type: "u8" },
          { name: "winnerPool"; type: "u64" },
          { name: "distributable"; type: "u64" },
          { name: "feeAmount"; type: "u64" },
          { name: "playerPrizeAmount"; type: "u64" },
          { name: "playerPrizeClaimed"; type: "bool" }
        ];
      };
    },
    {
...
export const IDL: GamePrediction = {
  version: "0.1.0",
  name: "game_prediction",
  instructions: [] as any,
  accounts: [] as any,
